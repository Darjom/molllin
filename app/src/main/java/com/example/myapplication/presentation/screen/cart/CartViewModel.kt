package com.example.myapplication.presentation.screen.cart

import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.example.myapplication.domain.order.CartItem
import com.example.myapplication.domain.order.Order
import com.example.myapplication.domain.user.User
import com.example.myapplication.repository.order.OrderRepository
